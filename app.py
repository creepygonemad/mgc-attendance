...
async def result():
    if request.method == 'POST':
        ...
        async with httpx.AsyncClient(follow_redirects=True) as client:
            response1 = await client.get(form_url)
            ...
            response2 = await client.post(result_url, data=payload)
            ...
            if response2.status_code == 200:
                response3 = await client.get(details_url, headers=lis_headers)
                ...
                lis_response = await client.post(list_url, headers=lis_headers, data=lis)
                ...
                if lis_response.status_code == 200:
                    ...
                    return render_template('result.html', name=student_name, att=att_percent, 
